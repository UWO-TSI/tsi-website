  ...
  "vp-marketing": [
    {
      id: "vp-mkt-1",
      question:
        "Show, don't tell. Submit a creative piece, in whatever medium is your strength (design, video, etc.), that makes the case for why you're the one for this role. Paste a link below.",
      max_words: 60,
    },
  ],
};
