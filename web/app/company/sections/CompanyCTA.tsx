  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      if (prefersReducedMotion) {
        gsap.set([contentRef.current, lineRef.current], { opacity: 1 });
    ...
    >
      ...
      <div
        ...
        style={{
          width: "700px",
          height: "400px",
          background: "radial-gradient(ellipse, rgba(29,155,240,0.10) 0%, transparent 70%)",
          filter: "blur(40px)",
        }}
      />
      ...
      <div className="relative max-w-[600px] mx-auto text-center">
        ...
        <div ref={contentRef} style={{ opacity: 0 }}>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="mailto:team@tethos.ca?subject=Company%20Inquiry"
              className="inline-flex items-center px-8 py-4 rounded-lg text-sm font-semibold transition-all duration-300"
              style={{
                background: "#1d9bf0",
                color: "#fff",
                fontFamily: '"Test Sohne", sans-serif',
            ...
            <Link
              ...
              style={{ color: "rgba(255,255,255,0.55)", fontFamily: '"Test Sohne", sans-serif' }}
            >
              Back to home
            </Link>
          </div>
