...
- **Waves T/U/W (`ecff396`, `e48622f`, `21b0d46`, 2026-07-06):** species-aware tree shakes (blossom → pink burst + cherry petal, verified live), stone lanterns on the Oracle walk, real ACNH bulletin boards for Bounty/Job (fallback kept), spawn campfire with flicker light, species-true fishing with in-world catch pop (E2E: "You caught a Dace!" + model above player). Collection book now fully species-true (8 flowers, 4 tree drops, 7 fish). All gates green per wave, builds exit 0.
- **Wave S (`e398ac6`, 2026-07-06):** seasonal shop decos wired to the active palette slug (principle #8 — verified live with a winter slug: snowman/garland/easel on the shop, then reverted), fountain pool disc, HQ entry glow. **Night pass finally verified properly** via `context.addInitScript` clock stub at 21:30: NIGHT palette, fireflies, streetlamp pools, entry glow all present. Gates green, build exit 0.
